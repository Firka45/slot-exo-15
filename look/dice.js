...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-27056c1b');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-27056c1b');}
...
function clearFlash(){dieView.classList.remove('rl-win-27056c1b');dieView.classList.remove('rl-lose-27056c1b');if(frameEl){frameEl.classList.remove('rl-win-27056c1b');frameEl.classList.remove('rl-lose-27056c1b');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-27056c1b');if(frameEl){frameEl.classList.add('rl-win-27056c1b');}}else{dieView.classList.add('rl-lose-27056c1b');if(frameEl){frameEl.classList.add('rl-lose-27056c1b');}}
...
var brandEl=document.querySelector('.rl-brand-27056c1b');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
